...
class MedicalInsurance():
    ...
    def load_model(self):
        with open(r'G:\linear_reg_medical_insurance\project_app\medical_model.pkl', 'rb') as f:
            self.medical_model = pickle.load(f)
        
        with open(r'G:\linear_reg_medical_insurance\project_app\project_data.json', 'r') as f:
    ...
    def get_predicted_charges(self):
        ...
        predicted_charges = np.around(self.medical_model.predict([test_array])[0],2)
